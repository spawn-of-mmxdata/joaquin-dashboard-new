...
user_password_pairs = {'drew.shives@hellommc.com' : 'PASamuelson06171989#', 'alexandra.stevens@hellommc.com' : '240803', 'joaquin@hellommc.com' : 'MMC_830!',
...
df_engagements = pd.read_excel('joaquin_act_spreadsheet.xlsx')
